...
const SECTIONS = {
  VARC: [
    "Verbal - RCs",
    "Verbal - Non-RC questions",
    "Verbal - Comprehension Session",
    "Verbal - Reading Session @ Class"
  ],
  DILR: [
    "DI - SuDoKu",
    "DI - Sets - Solving",
  ...
  Quant: [
    "Arithmetics - Percentages Fractions Tables",
    "Arithmetics - Percentages, Ratios and Proportions",
    "Arithmetics - Averages (Basics)",
    "Arithmetics - Weighted Average (Mixtures & Alligations)",
    "Arithmetics - Profit & Loss",
    "Arithmetics - SICI EMI",
    "Arithmetics - Problem Solving",
    "Numbers - Basics, Squares, Cubes, Primes, etc",
    "Numbers - Basic Divisibility",
    "Numbers - Base coversions",
    "Numbers - 1001 method",
    "Numbers - Chinese Remainder Theorem",
    "Numbers - Euler's, Wilsons Theorems",
    "Numbers - LCM, HCF, Factors, Prime Factorisation",
    "Numbers - Factorials Factorisation",
    "Numbers - Last 1 digit",
    "Numbers - Last 2 digits",
    "Numbers - Problem Solving",
    "Speed Time - Linear Tracks",
    "Speed Time - Trains and Platforms",
    "Speed Time - Boat and Stream",
    "Speed Time - Circular Tracks",
    "Speed Time - Escalator",
    "Speed Time - Time and Work",
    "Speed Time - Problem Solving",
    "Progressions - AP",
    "Progressions - GP",
    "Progressions - AM, GM, HM concepts",
    "Progressions - Infinite GP",
    "Progressions - Sum of n, n^2, n^3",
    "Progressions - Combo (GPGP, APAP, APGP, 1/AP 1/AP)",
    "Progressions - Common AP Series",
    "Progressions - Problem Solving",
    "Geometry - Lines and Angles",
    "Geometry - Trigonometry Basics",
    "Geometry - Triangle Classification",
    "Geometry - Triangle Areas",
    "Geometry - Triangle Similarities",
    "Geometry - Triangle Lines and Properties",
    ...
    "Equations - Slope",
    "Equations - Coordinate Geometry Basics",
    "Equations - Minima Maxima",
    "Equations - Cubic Equations",
    "Equations - Inequalities",
    "Equations - Modulus",
    "Equations - Logs & Exponentials",
    "Equations - Problem Solving",
    "P&C - Factorials",
    "P&C - Arrangements - Linear & Circular",
    "P&C - Arrangements - Constrained",
    "P&C - Selections - Basics",
    "P&C - Selections Pascal's Triangle",
    "P&C - Permutations",
    "P&C - Grouping",
    "P&C - Application oriented questions",
    "P&C - Probability - Basics",
    "P&C - Probability - Venn Diagram",
    "P&C - Probability - Condiional",
    "P&C - Problem Solving",
    "Mock CAT - Pre Test Induction",
    "Mock CAT - Test",
    "Mock CAT - Post Test Analysis",
    "Mock CAT - Live Mock - Sampath",
    "General - CAT Induction",
    "General - Doubt Clarification Session",
    "General - Application Filling Demo",
    "General - Group Discussion",
    "General - Interview Preparations"
  ]
